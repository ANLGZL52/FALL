...
# -------------------------
# DB dependency (projeye uyumlu fallback)
# -------------------------
def _make_get_db():
    """
    app.db içinde farklı patternler olabiliyor:
    - SessionLocal (classic)
    - get_db() (FastAPI dependency)
    - get_session()
    Bu fonksiyon hangisi varsa onu kullanır.
    """
    # 1) SessionLocal varsa
    try:
