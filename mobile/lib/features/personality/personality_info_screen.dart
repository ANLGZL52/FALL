...
class PersonalityInfoScreen extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      ...
                      "- Konu (genel/aşk/kariyer/para)\n"
                      "- Opsiyonel soru",
                      style: TextStyle(color: Colors.white, fontSize: 15, height: 1.3, fontWeight: FontWeight.w700),
                    ),
                    const SizedBox(height: 10),
                    Text(
                      "Not: Ödeme şimdilik 'mock'. Butona basınca ödeme yapılmış sayıp AI üretimi başlatıyoruz.",
                      style: TextStyle(color: AppColors.textSecondary.withOpacity(0.95), fontSize: 12, height: 1.35),
                    ),
                  ],
                ),
              ),
